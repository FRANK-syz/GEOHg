...
# HgDryDep = gdal.Open("BorealHg results/2021Hg0dep.tif").ReadAsArray()
# HgDryDep = gdal.Open("BorealHg results/2023Hg0dep.tif").ReadAsArray()
HgDryDep = gdal.Open("BorealHg results/15-19Hg0dep.tif").ReadAsArray()

Fillgap=HgDryDep[:,0]/2+HgDryDep[:,-1]/2
HgDryDep = np.column_stack((HgDryDep, Fillgap))
...
mesh = ax.contourf(lon_grid, lat_grid, HgDryDep, 
                   levels=bounds, 
                   cmap=cmap, 
...
# plt.savefig('BorealHg results/2021Hg0depfromMBOBB.png', transparent=True, dpi=300)
# plt.savefig('BorealHg results/2023Hg0depfromMBOBB.png', transparent=True, dpi=300)
plt.savefig('BorealHg results/15-19Hg0depfromMBOBB.png', transparent=True, dpi=300)
plt.show()
