...
# Hg2dep = gdal.Open("BorealHg results/GFED_Hg2dep.tif").ReadAsArray()
Hg2dep = gdal.Open("BorealHg results/MBOBB_Hg2dep.tif").ReadAsArray()
...
cbar = plt.colorbar(mesh, ax=ax, orientation='horizontal', 
                    ...
                    ticks=np.arange(0, 0.525, 0.05))
cbar.ax.tick_params(labelsize=10)

plt.title('Hg$^{II}$ deposition (μg m$^{-2}$ yr$^{-1}$)',fontsize=12, pad=20, y=-0.26, fontname='Arial')
# plt.savefig('BorealHg results/GFEDHg2Dep.png', transparent=True, dpi=300)
plt.savefig('BorealHg results/MBOBBHg2Dep.png', transparent=True, dpi=300)
